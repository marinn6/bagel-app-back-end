...
(6, 'Poppy Seed Bagel', 'A bagel topped with crunchy poppy seeds.', Traditional, 1.75, false, true),
(7, 'Chocolcate Chip Bagel', 'A sweet bagel with chocolate chips baked into the dough.', 'Sweet', 2.00, false, true),
(8, 'Asiago Cheese Bagel', 'A savory bagel topped with melted Asiago cheese.',
 'Savory', 2.25, false, true),
(9, 'Jalapeño Cheddar Bagel', 'A spicy bagel with jalapenos and melted cheddar cheese.', 'Savory', 2.25, false, true),
(10, 'Gluten-Free Bagel', 'A plain bagel made with gluten-free ingredients.', 'Gluten-Free', 2.50, true, true)